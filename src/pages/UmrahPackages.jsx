  ...
  return (
    <>
      <SEO
        ...
        description="Year-round Umrah packages from Lahore — Standard, Premium and Ramadan Special. Full visa assistance and on-ground support by RG Travels."
        keywords="Umrah packages Pakistan, Umrah Lahore, Ramadan Umrah, Umrah 2025"
        url="/umrah/packages"
      />
            ...
            >
              ...
              <div className="relative max-w-4xl mx-auto px-6 text-center">
                ...
                <p className="text-stone-300 text-base max-w-xl mx-auto leading-relaxed mb-10">
                  We are crafting exclusive Umrah packages tailored for
                  Pakistani pilgrims. Register your interest and we'll notify
                  you the moment they're available.
                </p>
